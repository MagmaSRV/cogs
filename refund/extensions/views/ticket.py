...
from refund.extensions.views.confirmation import Confirmation
from refund.extensions.views.alert import Alert

if TYPE_CHECKING:
    from refund.extensions.views.queue import Queue
    from refund.refund import refund
    ...
    async def assign_moderator(self, button: discord.ui.Button, interaction: discord.Interaction):
        ...
        prompt = discord.Embed(
            ...
            description=(
                ...
                "assign to this ticket. They must be a Red Admin or have a refund "
        ...
        if not (
            ...
            alert = Alert(
                title="Failed to Assign Moderator",
                description="The specified user is not a Red Admin or refund Support",

...
@checks.admin()
@build.group(invoke_without_command=True, aliases=["set"])
async def settings(self, ctx):
    """Manage settings for build"""
    await ctx.send_help()
    ...
    build_channel = getattr(self.bot.get_channel(
        guild_settings["build"]), "name", "Not set")

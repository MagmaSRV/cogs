...
from build.extensions.views.confirmation import Confirmation
from build.extensions.views.alert import Alert

if TYPE_CHECKING:
    from build.extensions.views.queue import Queue
...
class Ticket(discord.ui.View):
    ...
    async def assign_moderator(self, button: discord.ui.Button, interaction: discord.Interaction):
        ...
        prompt = discord.Embed(
            ...
            description=(
                ...
                "assign to this ticket. They must be a Red Admin or have a build "
        ...
        if not (
            ...
            alert = Alert(
                title="Failed to Assign Moderator",
                description="The specified user is not a Red Admin or build Support",
    ...
    async def close_ticket(self, button: discord.ui.Button, interaction: discord.Interaction):
        ...
        if result:
            ...
            await self.ctx.cog.build_close(
                ctx=self.ctx,
                ticket=self.ticket,
                author=author,

...
@checks.admin()
@form.group(invoke_without_command=True, aliases=["set"])
async def settings(self, ctx):
    """Manage settings for form"""
    await ctx.send_help()
    ...
    form_channel = getattr(self.bot.get_channel(
        guild_settings["form"]), "name", "Not set")

...
from form.extensions.views.confirmation import Confirmation
from form.extensions.views.alert import Alert
    ...
    async def assign_moderator(self, button: discord.ui.Button, interaction: discord.Interaction):
        ...
        prompt = discord.Embed(
            ...
            description=(
                ...
                "assign to this ticket. They must be a Red Admin or have a form "
        ...
        if not (
            ...
            alert = Alert(
                title="Failed to Assign Moderator",
                description="The specified user is not a Red Admin or form Support",

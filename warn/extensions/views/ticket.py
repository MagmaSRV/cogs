...
from warn.extensions.views.confirmation import Confirmation
from warn.extensions.views.alert import Alert

if TYPE_CHECKING:
    from warn.extensions.views.queue import Queue
    from warn.warn import Warn
    ...
    async def assign_moderator(self, button: discord.ui.Button, interaction: discord.Interaction):
        ...
        prompt = discord.Embed(
            ...
            description=(
                ...
                "assign to this ticket. They must be a Red Admin or have a Warn "
        ...
        if not (
            ...
            alert = Alert(
                title="Failed to Assign Moderator",
                description="The specified user is not a Red Admin or Warn Support",
